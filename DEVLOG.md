...
- [ ] Single script (or collection of scripts) to download data. Filter `data-core/site_info.csv` for that specific data type; then, run the corresponding download script for those sites.
